...
const alertVariants = cva(
  "relative w-full rounded-lg border border-stone-200 p-4 dark:border-stone-800 [&>svg+div]:translate-y-[-3px] [&>svg]:absolute [&>svg]:left-4 [&>svg]:top-4 [&>svg]:text-stone-950 dark:[&>svg]:text-stone-50 [&>svg~*]:pl-7",
  {
    variants: {
      variant: {
