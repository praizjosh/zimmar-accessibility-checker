  ...
  return (
    <Popover>
      <PopoverTrigger
        ...
        className="flex size-11 shrink-0 items-center justify-center rounded-md border border-rose-50/20 text-grey transition-colors hover:border-accent hover:text-accent focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent focus-visible:ring-offset-2 focus-visible:ring-offset-dark-shade"
      >
      ...
      <PopoverContent align="end" className="w-64 space-y-4">
        ...
        <DeviceTypeToggle
          ...
          label={
            <span className="text-sm font-medium text-grey">Designing for</span>
          }
        />
      </PopoverContent>
    </Popover>
