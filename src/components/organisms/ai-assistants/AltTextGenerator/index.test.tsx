...
describe("AltTextGenerator", () => {
  ...
  it("does not render the generator controls when collapsed", () => {
    ...
    expect(
      screen.queryByRole("button", { name: "Generate alt text" }),
  ...
  it("expands when the collapsed row is clicked", async () => {
    ...
    render(
      <AltTextGenerator isExpanded={false} setIsExpanded={setIsExpanded} />,
    );

    await user.click(
      screen.getByRole("button", { name: /Alt Text Generator/i }),
    );
  ...
  it("collapses via the labelled chevron button when expanded", async () => {
    ...
    await user.click(
      screen.getByRole("button", { name: "Collapse Alt Text Generator" }),
    );
  ...
  it("shows the generated alt text and remaining quota on success", async () => {
    ...
    expect(
      screen.getByLabelText("Copy generated alt text to clipboard"),
    ).toBeVisible();
  });
  ...
  it("copies the generated alt text and notifies the backend on success", async () => {
    ...
    expect(
      await screen.findByLabelText("Text copied to clipboard"),
    ).toBeVisible();
